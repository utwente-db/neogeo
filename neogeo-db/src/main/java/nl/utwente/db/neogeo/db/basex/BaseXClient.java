...
/**
 * Source: https://github.com/BaseXdb/basex-api/blob/master/src/main/java/BaseXClient.java
 * WARNING: Not thread-safe. Instantiate a new client if working in parallel.
 * 
